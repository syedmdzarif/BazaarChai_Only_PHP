...
<!DOCTYPE html>
 ...
 <head>
    ...
    <link rel="stylesheet" type="text/css" href="customer_list.css">
 ...
 <body>
   ...
   <nav id="navbar">
      ...
      <div class="panels">
         ...
         <div class = "form-box">
         <input type="text" class="search-field" placeholder="Search customers with id, name, phone..." name="search1" required value="<?php if(isset($_GET['search1'])){echo $_GET['search1']; } ?>"/>
       ...
       if(isset($_GET['search1'])){
          $values = $_GET['search1'];
       $query = "SELECT id, name, address, email, phone FROM customer WHERE id LIKE '%$values%' OR name LIKE '%$values%' OR address LIKE '%$values%' OR email LIKE '%$values%' OR phone LIKE '%$values%'";
...
$customers = mysqli_query($result3, MYSQLI_ASSOC);*/
   ...
   ?>
                     ...
                     <tr>
                           ...
                           <td><?php echo htmlspecialchars($customers['id']); ?></td>
                        
                           <td><?php echo htmlspecialchars($customers['name']); ?></td>
                           <td><?php echo htmlspecialchars($customers['phone']); ?></td>
                           <td><?php echo htmlspecialchars($customers['address']); ?>
                           ...
                           <td>
                             ...
                             <form action="admin_profile.php" method="POST">
                              <input type = "hidden" name = "order_no_id" value="<?php echo $customers['id']?>">
    ...
    foreach($customers as $customer){
      ...
      ?>
                     ...
                     <tr>
                           ...
                           <td><?php echo htmlspecialchars($customer['address']); ?>
                           ...
                           <td>
                             ...
                             <form action="admin_profile.php" method="POST">
                              <input type = "hidden" name = "order_no_id" value="<?php echo $customer['id']?>">
                                <input type="submit" name="delete" class='search-btn' value="Chat">
